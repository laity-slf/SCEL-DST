...
from transformers.models.albert.modeling_albert import (AlbertModel,AlbertConfig,ALBERT_PRETRAINED_MODEL_ARCHIVE_LIST,ALBERT_INPUTS_DOCSTRING,ALBERT_START_DOCSTRING)
...
@add_start_docstrings(
    """AoBERT Model with classification heads for the DST task. """,
    ALBERT_START_DOCSTRING,
)
class AlbertForDST(AlbertPreTrainedModel):
    def __init__(self, config):
        super(AlbertForDST, self).__init__(config)
